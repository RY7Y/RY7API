...
// ✅ إنشاء الجدول D1const CREATE_SQL = `const CREATE_SQL = `CREATE TABLE IF NOT EXISTS codes (// ✅ تعريف الجدولconst CREATE_SQL = `
